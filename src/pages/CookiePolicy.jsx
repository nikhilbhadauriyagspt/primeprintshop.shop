...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This Cookie Policy explains how Primeprintshop LLC ("Company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://primeprintshop.shop/">https://primeprintshop.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@primeprintshop.shop">info@primeprintshop.shop</a></li>
        <li>Visiting: <Link to="/contact">https://primeprintshop.shop/contact</Link></li>
      </ul>
      ...
      <div className="bg-gray-50 p-8 rounded-sm border border-[#e9e9e9] my-8 not-prose">
        <address className="not-italic text-gray-700 font-bold leading-relaxed space-y-2">
          ...
          <p>United States</p>
          <p className="pt-4 flex items-center gap-3 text-[#007DBA] font-extrabold">info@primeprintshop.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
